...
def merge_dataframes(primary_df: pd.DataFrame, ops_df: pd.DataFrame, hoo_df: pd.DataFrame) -> pd.DataFrame:
    ...
    hoo_cols = ['RecordID', 'NameNormalized', 'HOO_Name', 'Agency Name', 'HOO_PrincipalOfficerName', 'HeadOfOrganizationTitle', 'source', 'AgencyNameEnriched', 'HOO_PrincipalOfficerContactLink']
