...
def merge_dataframes(primary_df: pd.DataFrame, ops_df: pd.DataFrame, hoo_df: pd.DataFrame) -> pd.DataFrame:
    ...
    hoo_cols = ['RecordID', 'NameNormalized', 'HOO_Name', 'Agency Name', 'HeadOfOrganizationName', 'HeadOfOrganizationTitle', 'source', 'AgencyNameEnriched', 'PrincipalOfficerContactURL', 'PrincipalOfficerName', 'HOO_PrincipalOfficerName', 'HeadOfOrganizationURL']
